...
const About = () => {
    return (
        <div
            id="about"
            className="flex flex-col items-center justify-center h-3/4 mt-20 bg-white-100 py-12 px-8 pt-20" // Added pt-20
            ...
            <div className="flex flex-col md:flex-row items-center max-w-7xl w-full">
                <div className="md:w-1/2 p-12 text-center">
                    ...
                    <p className="text-m text-gray-600 mb-8">
                        Here’s what{' '}
                        <ScrollLink to="projects" smooth={true} duration={500} className="text-orange-500 hover:underline cursor-pointer">
                            I've been up to
                        </ScrollLink>{' '}
                        and{' '}
                        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">
                            my resume
                        </a>.
                    </p>
                    <div className="flex justify-center">
                        <a
                            href="mailto:jeremiahnpitts@gmail.com"
                            className="inline-flex items-center px-6 py-3 bg-orange-500 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 transition ease-in-out duration-300"
                        >
                            Contact Me
                        </a>
                    </div>
